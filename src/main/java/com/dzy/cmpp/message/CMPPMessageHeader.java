...
public class CMPPMessageHeader {
    ...
    public CMPPMessageHeader(int commandId, int commandLength) {
    ...
    public String toString() {
        StringBuffer buffer = new StringBuffer();
        buffer.append("CMPPMessageHeader:[sequenceId=").append(sequenceString()).append(",").append(
